<template>
  ...
  <div>
    ...
    <el-table :data="data" style="width: 100%" height="70vh">
      <el-table-column prop="node_id" label="物种ID"></el-table-column>
      <el-table-column prop="taxon_name" label="植物学名"></el-table-column>
      <el-table-column prop="family" label="分类学所属科"></el-table-column>
      <el-table-column prop="genus" label="分类学所属属"></el-table-column>
      <el-table-column prop="ch_name" label="中文名"></el-table-column>
      <el-table-column prop="area" label="所属国家"></el-table-column>
...
function SearchAllNodes() {
  axios({
    method: 'post',
    url: 'http://localhost:8080/findAllSpeciesWithPage', // Replace with your actual API endpoint
    params: {
...
function getAllNodesCounts() {
  axios({
    method: 'post',
    url: 'http://localhost:8080/countAllSpecies', // Replace with your actual API endpoint
  })
    .then(response => {
